    ...
    >
      ...
      <div className="relative mt-20 mb-10 ml-[17rem] scale-90 sm:mb-16 md:mt-24 md:ml-0 md:scale-100">
        ...
        <div className="absolute -top-3 left-[130px]">
          <div className="relative flex items-center justify-center">
            ...
            <div
              ...
              className="absolute size-10 animate-[ping_5s_ease_infinite] rounded-full ring-1 ring-blue-400/50"
            ></div>
          </div>
        </div>
        <div className="absolute top-[73px] left-[243px]">
          <div className="relative flex items-center justify-center">
            ...
            <div
              ...
              className="absolute size-10 animate-[ping_5s_ease_infinite] rounded-full ring-1 ring-yellow-400/50"
            ></div>
          </div>
        </div>
        <div className="absolute top-32 right-[300px]">
          <div className="relative flex items-center justify-center">
            ...
            <div
              ...
              className="absolute size-10 animate-[ping_5s_ease_infinite] rounded-full ring-1 ring-green-400/50"
            ></div>
          </div>
        </div>
        <div className="absolute top-20 right-[390px]">
          <div className="relative flex items-center justify-center">
            <div className="absolute size-10 rounded-full bg-gray-950 ring-1 ring-white/15"></div>
            <RiHome9Fill className="relative size-5 text-orange-400" />
          </div>
        </div>
        ...
        <div className="absolute top-9 right-56">
          <div className="relative flex items-center justify-center">
            <RiSignalTowerFill className="z-10 size-5 text-pink-400" />
